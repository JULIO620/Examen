...
public class Login extends javax.swing.JFrame {
   ...
   public void validar() {
    ...
    String pass = String.valueOf(passChars);

    if (correo.isEmpty() || pass.isEmpty()) {
        JOptionPane.showMessageDialog(null, "Por favor, complete todos los campos.");
    } else if (pass.length() < 8) {
        JOptionPane.showMessageDialog(null, "La contraseña debe tener al menos 8 caracteres.");
    } else if (!containsDigit(pass) || !containsLowerCase(pass) || !containsUpperCase(pass) || !containsSymbol(pass)) {
        JOptionPane.showMessageDialog(null, "La contraseña debe contener números, mayúsculas, minúsculas y al menos un símbolo.");
    } else {
...
private boolean containsSymbol(String str) {
  ...
  sistema.mostrarMateriasPrimasAgotadasEnTabla();
